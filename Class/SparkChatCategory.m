...
@implementation UIView(SparkChatCategory)
...
{
	NSString *resourceBundlePath = [[NSBundle bundleForClass:[SparkChatMessage class]] pathForResource:@"UUChatTableView" ofType:@"bundle"];
